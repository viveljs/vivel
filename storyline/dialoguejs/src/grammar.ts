...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "sentence$string$1", "symbols": [{"literal":"B"}, {"literal":"a"}, {"literal":"t"}, {"literal":"t"}, {"literal":"e"}, {"literal":"r"}, {"literal":"y"}, {"literal":":"}], "postprocess": (d) => d.join('')},
    {"name": "sentence$string$2", "symbols": [{"literal":"V"}, {"literal":"o"}, {"literal":"l"}, {"literal":"t"}], "postprocess": (d) => d.join('')},
    {"name": "sentence", "symbols": ["sentence$string$1", "_", "percentage", "_", {"literal":","}, "_", "decimal", "_", "sentence$string$2"]}
  ],
  ParserStart: "",
};
